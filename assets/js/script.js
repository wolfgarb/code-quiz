var questions = [
  {
    question:
      "What is the proper command for creating a new file using the CLI?",
  ...
  },
  {
    ...
    answers: [
      ...
      "Writing the html files first",
      "The practice of sketching an outline of a page's layout",
      "The practice of laying out the CSS page",
    ],
  ...
  },
  {
    ...
    answers: [
      "JS is outdated",
      "JS cannot interpret hypens",
      "JS has a smoking problem",
  ...
  },
  {
    ...
    answers: [
      "So the computer can write in it's diary like in Star Trek",
      "To save data to local storage",
      "To save your progress with Git",
      "To ensure your code is coming along",
    ],
    correct: "To ensure your code is coming along",
  },
  { question: "What is 2 + 2?", answers: ["$", "5", "4", "0"], correct: "4" },
];
...
function endGame() {
  ...
  if (playerScore === 0) {
    $("#result").text(
      "You scored " + playerScore + " out of 6. Do you really not know 2 + 2?!"
    );
  } else {
    $("#result").text(
      "Let's see how you did! Your score was " + playerScore + " out of 6."
    );
...
$("#submit").on("click", function () {
  ...
  localStorage.setItem("newHighScore", JSON.stringify(highScores));
  loadScores();
});
...
// get scores to load to high score page
// var loadScores = function (playerName, playerScore) {
...
// create event listener for when the high score link is clicked?
